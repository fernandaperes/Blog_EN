...
ggsave(plot = g9, "g9.png", height = 2, width = 2.8, dpi = 400)

knitr::include_graphics("g9.png")
```
  
In the plot below, the median overlaps with Q1 (the bottom of the box is represented by a thicker line), and the upper limit is overlapped with Q3 (there is no "T" extending beyond the upper limit): 
...
ggsave(plot = g10, "g10.png", height = 2, width = 2.8, dpi = 400)
